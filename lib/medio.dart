...
class TelaJogoAdivinhacaoM extends StatefulWidget {
  final String nivel;
  TelaJogoAdivinhacaoM({required this.nivel});

  @override
  _TelaJogoAdivinhacaoMState createState() => _TelaJogoAdivinhacaoMState();
}

class _TelaJogoAdivinhacaoMState extends State<TelaJogoAdivinhacaoM> {
  ...
  void _verificarAdivinhacao() {
    ...
    setState(() {
      ...
      if (widget.nivel == 'Médio' && _tentativas >= _maxTentativas) {
        Navigator.push(
          context,
