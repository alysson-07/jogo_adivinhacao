...
class TelaJogoAdivinhacaoD extends StatefulWidget {
  final String nivel; 
  TelaJogoAdivinhacaoD({required this.nivel});

  @override
  _TelaJogoAdivinhacaoDState createState() => _TelaJogoAdivinhacaoDState();
}

class _TelaJogoAdivinhacaoDState extends State<TelaJogoAdivinhacaoD> {
  ...
  void _verificarAdivinhacao() {
    ...
    setState(() {
      ...
      if (widget.nivel == 'Difícil' && _tentativas >= _maxTentativas) {
        Navigator.push(
          context,
